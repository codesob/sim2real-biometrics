...
def main():
    ...
    train_transform = transforms.Compose([
        ...
        # YOUR NOVELTY (Only for training)
    ...
    print(f"Train Size: {len(train_dataset)} (Blurred) | Val Size: {len(val_dataset)} (Clean)")
    ...
    for epoch in range(EPOCHS):
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(backbone.state_dict(), os.path.join(SAVE_DIR, "best_model_new.pth"))
